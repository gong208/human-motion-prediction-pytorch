...
<div style="text-align: center;">
  <div style="display: inline-block; margin-right: 5px; text-align: center;">
    <img src="imgs/walking_Residual_MA.gif" alt="walking_Residual_MA" style="width: 400px; height: auto;">
    <p>Walking - Residual MA</p>
  </div>
  <div style="display: inline-block; margin-right: 5px; text-align: center;">
    <img src="imgs/walking_Residual_SA.gif" alt="walking_Residual_SA" style="width: 400px; height: auto;">
    <p>Walking - Residual SA</p>
  </div>
  <div style="display: inline-block; text-align: center;">
    <img src="imgs/walking_sampling.gif" alt="walking_Sampling" style="width: 400px; height: auto;">
...
<div style="text-align: center; margin-top: 20px;">
  <div style="display: inline-block; margin-right: 5px; text-align: center;">
    <img src="imgs/eating_Residual_MA.gif" alt="eating_Residual_MA" style="width: 400px; height: auto;">
    <p>Eating - Residual MA</p>
  </div>
  <div style="display: inline-block; margin-right: 5px; text-align: center;">
    <img src="imgs/eating_Residual_SA.gif" alt="eating_Residual_SA" style="width: 400px; height: auto;">
    <p>Eating - Residual SA</p>
  </div>
  <div style="display: inline-block; text-align: center;">
    <img src="imgs/eating_Sampling.gif" alt="eating_Sampling" style="width: 400px; height: auto;">
    <p>Eating - Sampling</p>
  </div>
</div>
